...
export const Dashboard: React.FC = () => {
  ...
  return (
    <div
      ...
      className="w-full h-screen overflow-hidden p-3 box-border flex flex-col gap-2.5 bg-[#0A0E1A] select-none"
    >
      {/* HEADER DO CONTEÚDO (Máximo 40px, shrink-0, linha única compacta) */}
      <header
        id="dashboard-header"
        className="h-[40px] shrink-0 flex items-center justify-between gap-3 px-3 rounded-lg bg-[#111827] border border-blue-500/20"
      >
        {/* Título inline com subtítulo separado por · */}
        <div className="flex items-center gap-2 min-w-0">
          <h1 className="text-[13px] font-bold text-white tracking-tight truncate leading-none">
            Bom dia, {firstName}.
          </h1>
          <span className="text-gray-500 text-[11px]">·</span>
          <p className="text-[11px] text-gray-400 truncate leading-none hidden sm:inline">
        ...
        <div className="flex items-center gap-2 shrink-0">
          ...
          <form onSubmit={handleSearchSubmit} className="relative w-[180px] md:w-[220px]">
            ...
            <input
              ...
              className="w-full h-[28px] bg-[#0A0E1A] border border-blue-500/20 rounded-md pl-8 pr-2.5 text-[11px] text-white placeholder-gray-500 focus:outline-none focus:border-blue-400 transition-all leading-none"
            />
          </form>
          ...
          <button
            ...
            className={`h-[28px] flex items-center gap-1.5 px-2 rounded-md text-[11px] font-semibold border transition-all cursor-pointer leading-none ${
              showFilters || Object.keys(filters).length > 0
                ? 'bg-blue-600/20 text-blue-400 border-blue-500/40'
                : 'bg-[#0A0E1A] text-gray-300 border-blue-500/20 hover:border-blue-500/40'
            }`}
          >
          ...
          <button
            ...
            className="h-[28px] w-[28px] flex items-center justify-center rounded-md bg-[#0A0E1A] border border-blue-500/20 text-gray-400 hover:text-white transition-colors cursor-pointer"
          >
          ...
          <div className="hidden lg:flex items-center gap-2 border-l border-white/[0.08] pl-2.5">
            <div className="flex items-center gap-1 text-[11px] font-mono text-gray-300 leading-none">
              <Clock className="w-3 h-3 text-blue-400" />
              <span>{currentTime}</span>
            </div>
            <span className="text-[10px] bg-emerald-500/15 text-emerald-400 px-2 py-0.5 rounded-full border border-emerald-500/30 font-mono font-bold flex items-center gap-1 leading-none">
      ...
      >
        ...
        <KpiCard
          ...
          icon={Cpu}
          iconBg="bg-blue-500/15 text-[#3B82F6]"
        ...
        <KpiCard
          ...
          icon={CheckCircle2}
          iconBg="bg-emerald-500/15 text-[#10B981]"
        ...
        <KpiCard
          ...
          icon={AlertCircle}
          iconBg="bg-red-500/15 text-[#EF4444]"
        ...
        <KpiCard
          ...
          icon={DollarSign}
          iconBg="bg-amber-500/15 text-[#F59E0B]"
