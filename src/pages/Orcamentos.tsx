    ...
    try {
      ...
      if (ocorrencia) {
        ...
        const labelFase: Record<string, string> = {
          ...
          CONCLUIDA: 'Ocorrência Registrada',
        };
        const detalhes = [
        ...
        // 3. Reseta fluxo para PPAC_ENVIADO
