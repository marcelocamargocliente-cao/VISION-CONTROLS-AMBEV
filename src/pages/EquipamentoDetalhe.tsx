...
export const EquipamentoDetalhe: React.FC = () => {
  ...
  return (
    <>
    <div className="equipamento-detalhe-page flex flex-col px-0 py-0 md:px-4 md:py-3 gap-4 max-w-7xl mx-auto w-full h-full overflow-y-auto scroll-fluido">
      {/* Header Bar */}
      ...
      <div className="equipamento-tab-content flex-1">
        ...
        {activeTab === 'ficha' && (
          <div className="bg-[#111827] border border-[#30363D] rounded-none md:rounded-lg px-3 py-3 md:p-6 space-y-5 md:space-y-6 shadow-xl w-full">
            {isEditing && (
