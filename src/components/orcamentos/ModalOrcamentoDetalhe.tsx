    ...
    try {
      ...
      if (formData.status === 'APROVADO' || formData.status === 'APROVADO_AMBEV') {
        confetti({
          ...
          spread: 70,
          origin: { y: 0.6 },
          colors: ['#2ECC71', '#8B949E', '#8B949E', '#FFFFFF'],
        });
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="flex items-center gap-2 flex-wrap">
                ...
                {ocorrencia?.numero && (
                  <span className="px-2 py-0.5 rounded-[2px] font-mono text-[10px] font-bold bg-[#E5E7EB] text-[#374151] border border-[#D1D5DB]">
                ...
                {isEditing && (
                  <span className="px-2 py-0.5 rounded-[2px] font-mono text-[10px] font-bold bg-[#E5E7EB] text-[#374151] border border-[#D1D5DB] animate-pulse">
                    ✏️ Modo Edição
                  </span>
                )}
              </div>
              <div className="flex items-center gap-3 mt-0.5">
                <h3 className="text-lg font-mono font-bold text-[#ECEFF1] tracking-wide">
                  {isEditing ? (
                    <input
                      ...
                      className="bg-[#1C222A] border border-[#D1D5DB] text-[#374151] px-2 py-0.5 rounded text-base font-mono focus:outline-none focus:ring-1 focus:ring-[#8B949E]"
                ...
                {isAuthorizedToEdit && !isEditing && (
                  <button
                    ...
                    className="inline-flex items-center gap-1 px-2 py-0.5 text-[10px] font-bold rounded-[3px] bg-[#E5E7EB] hover:bg-[#E5E7EB] text-[#374151] border border-[#D1D5DB] transition-colors"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
            ...
            <div className="lg:col-span-6 space-y-5 bg-[#14181D]/60 p-4 sm:p-5 rounded-[4px] border border-[#2C343E]">
              <div className="flex items-center justify-between border-b border-[#2C343E] pb-2">
                <span className="text-[11px] font-mono uppercase text-[#374151] font-bold tracking-wider flex items-center gap-1.5">
              ...
              <div className="p-3.5 bg-[#1C222A] border border-[#D1D5DB] rounded-[4px] flex items-center justify-between">
                <div>
                  ...
                  {isEditing ? (
                    <div className="flex items-center gap-1.5 mt-1">
                      <span className="text-sm font-mono text-[#374151] font-bold">R$</span>
                      <input
                        type="text"
                        inputMode="numeric"
                        ...
                        placeholder="0,00"
                        className="bg-[#14181D] border border-[#D1D5DB] text-[#374151] px-2 py-1 rounded text-xl font-bold font-mono w-44 focus:outline-none focus:ring-1 focus:ring-[#8B949E]"
                      />
                    </div>
                  ) : (
                    <span className="text-2xl sm:text-3xl font-condensed font-bold text-[#374151] tracking-tight">
                ...
                <div className="text-right">
                  ...
                  {isEditing ? (
                    <select
                      ...
                      className="bg-[#14181D] border border-[#2C343E] text-[#ECEFF1] text-xs rounded px-2 py-1 font-mono font-bold mt-1 focus:border-[#D1D5DB] focus:outline-none"
                    >
              ...
              <div>
                ...
                {isEditing ? (
                  <input
                    ...
                    className="w-full bg-[#1C222A] border border-[#2C343E] rounded px-3 py-1.5 text-xs text-[#ECEFF1] focus:border-[#D1D5DB] focus:outline-none"
                    ...
                    <span
                      className={`inline-flex items-center px-1.5 py-0.5 rounded-[2px] font-mono text-xs font-bold ${
                        diasEnvio > 15
                          ...
                          : diasEnvio >= 8
                          ? 'bg-[#E5E7EB] text-[#374151] border border-[#D1D5DB]'
              ...
              <div>
                ...
                {isEditing ? (
                  ...
                  <div className="flex items-center gap-2 text-xs text-[#ECEFF1] bg-[#1C222A] p-2.5 rounded-[4px] border border-[#2C343E]">
                    <User className="w-3.5 h-3.5 text-[#374151]" />
              ...
              <div>
                ...
                <input
                  ...
                  className={`w-full bg-[#1C222A] border rounded px-3 py-1.5 text-xs text-[#ECEFF1] focus:outline-none font-mono transition-colors ${
                    formData.numero_pedido ? 'border-green-500/40 focus:border-green-500' : 'border-[#2C343E] focus:border-[#2563EB]'
                  }`}
              ...
              <div>
                ...
                {isEditing ? (
                  <textarea
                    ...
                    className="w-full bg-[#1C222A] border border-[#2C343E] rounded p-2 text-xs text-[#ECEFF1] focus:border-[#D1D5DB] focus:outline-none"
              ...
              <div className="border-t border-[#2C343E]/60 pt-3">
                <div className="flex items-center justify-between">
                  <span className="text-[10px] font-mono uppercase text-[#94A3B8] flex items-center gap-1.5">
                    <Paperclip className="w-3.5 h-3.5 text-[#374151]" />
                  ...
                  {orcamento.arquivo_pdf_url || orcamento.arquivo_url ? (
                    <button
                      ...
                      className="text-[11px] font-mono text-[#374151] hover:underline flex items-center gap-1"
                    >
                  ...
                  <div className="mt-2">
                    ...
                    <div className="flex items-center gap-2">
                      <button
                        ...
                        className="px-3 py-1.5 bg-[#2C343E] hover:bg-[#E5E7EB] text-[#ECEFF1] hover:text-[#374151] border border-[#D1D5DB] rounded text-xs font-semibold flex items-center gap-1.5"
                      >
              ...
              <div className="flex items-center justify-between border-b border-[#2C343E] pb-2">
                ...
                {ocorrencia && (
                  <div className="flex items-center gap-2">
                    ...
                    <button
                      onClick={() => { onClose(); navigate(`/ocorrencias/${ocorrencia.id}`); }}
                      className="text-[11px] font-mono text-[#374151] hover:underline flex items-center gap-1 font-bold"
                    >
              ...
              <div className="p-3.5 bg-[#1C222A] border border-[#2C343E] rounded-[4px] space-y-3">
                <div className="flex flex-wrap items-center justify-between gap-2">
                    ...
                    {ocorrencia ? (
                      <div className="flex items-center gap-2 mt-0.5">
                        <div className="space-y-0.5">
                          <div className="flex items-center gap-2 flex-wrap">
                            <span className="font-mono font-bold text-sm text-[#374151]">
                        ...
                        >
                          {ocorrencia.status === 'AGUARDANDO_ORCAMENTO'
                            ? (orcamento.status === 'EXPIRADO' ? 'ORÇAMENTO EXPIRADO' : 'ORÇAMENTO ENVIADO')
                  ...
                  <div>
                    ...
                    {equipamento ? (
                      <span className="bg-[#E5E7EB] text-[#374151] font-bold text-[11px] rounded px-2 py-0.5 border border-[#D1D5DB] font-mono">
                      ...
                      <tbody className="divide-y divide-[#2C343E]/50 text-[#ECEFF1]">
                        {pecas.map((peca) => (
                          <tr key={peca.id} className="hover:bg-[#232B35]">
                            ...
                            <td className="py-1.5 px-2 font-mono text-[10px] text-[#374151]">
                              {peca.part_number || '-'}
                            </td>
              ...
              <div className="p-3 bg-[#1C222A] border border-[#2C343E] rounded-[4px]">
                ...
                {isEditing ? (
                  <textarea
                    ...
                    className="w-full bg-[#14181D] border border-[#D1D5DB] focus:border-[#D1D5DB] rounded px-2.5 py-1.5 text-xs text-[#ECEFF1] focus:outline-none resize-y"
              ...
              <div className="flex flex-wrap items-center gap-2">
                ...
                <button
                  ...
                  className={`inline-flex items-center gap-2 px-3.5 py-2 text-xs font-semibold rounded-[4px] border transition-colors shadow-sm ${
                    orcamento.arquivo_pdf_url || orcamento.arquivo_url
                      ? 'bg-[#E5E7EB] hover:bg-[#E5E7EB] text-[#374151] border-[#D1D5DB]'
                ...
                {isAuthorizedToEdit && (
                  <button
                    ...
                    type="button"
                    onClick={() => setIsEditing(true)}
                    className="inline-flex items-center gap-2 px-3.5 py-2 text-xs font-semibold rounded-[4px] bg-[#E5E7EB] hover:bg-[#E5E7EB] text-[#374151] border border-[#D1D5DB] transition-colors shadow-sm"
                  >
