  ...
  return (
    ...
    >
      <div
        ...
        className="bg-[#1C222A] border border-[#D1D5DB] rounded-[6px] shadow-2xl w-full max-w-xl overflow-hidden animate-in fade-in zoom-in-95 duration-150"
          ...
          <div className="flex items-center gap-2.5">
            ...
            <div>
              ...
              <p className="text-[10px] text-[#94A3B8] font-mono">
                Baseado na proposta anterior: <span className="text-[#374151]">{orcamentoOrigem.numero}</span>
              </p>
            </div>
          </div>
          <button
        ...
        <form onSubmit={handleSubmit} className="p-5 space-y-4">
          ...
          <div>
            ...
            <input
              ...
              className="w-full bg-[#14181D] border border-[#D1D5DB] rounded px-3 py-2 text-sm font-mono font-bold text-[#374151] focus:ring-1 focus:ring-[#8B949E] focus:outline-none"
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full bg-[#14181D] border border-[#2C343E] rounded px-3 py-2 text-xs font-mono font-bold text-[#ECEFF1] focus:border-[#D1D5DB] focus:outline-none"
                  placeholder="0,00"
                />
              </div>
            </div>
            ...
            <div>
              ...
              <input
                ...
                className="w-full bg-[#14181D] border border-[#2C343E] rounded px-3 py-2 text-xs font-mono text-[#ECEFF1] focus:border-[#D1D5DB] focus:outline-none"
              />
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            <div>
              ...
              <input
                ...
                className="w-full bg-[#14181D] border border-[#2C343E] rounded px-3 py-2 text-xs text-[#ECEFF1] focus:border-[#D1D5DB] focus:outline-none"
          ...
          <div className="p-3.5 bg-[#14181D] border border-[#2C343E] rounded-[4px]">
            <div className="flex items-center justify-between mb-1.5">
              <label className="text-[10px] uppercase font-mono text-[#374151] font-bold flex items-center gap-1.5">
            ...
            <div className="flex flex-col sm:flex-row items-center gap-2 mt-2">
              <button
                ...
                className="w-full sm:w-auto px-4 py-2 bg-[#2C343E] hover:bg-[#E5E7EB] text-[#ECEFF1] hover:text-[#374151] border border-[#D1D5DB] rounded text-xs font-semibold flex items-center justify-center gap-2 transition-colors"
              >
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full bg-[#14181D] border border-[#2C343E] rounded p-2.5 text-xs text-[#ECEFF1] focus:border-[#D1D5DB] focus:outline-none"
          ...
          <div className="pt-3 border-t border-[#2C343E] flex items-center justify-end gap-2.5">
            ...
            <button
              ...
              type="submit"
              disabled={submitting}
              className="px-4 py-2 text-xs font-bold rounded-[4px] bg-[#E5E7EB] hover:bg-[#0284C7] text-[#14181D] transition-colors shadow-md flex items-center gap-1.5"
            >
