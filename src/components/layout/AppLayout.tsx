...
export const AppLayout: React.FC = () => {
  ...
  return (
    <div className="min-h-screen md:h-screen w-full flex bg-[#0D1117] font-body text-[#E6EDF3] md:overflow-hidden">
      {/* ============================================================
      ...
      <div className="flex-1 flex flex-col min-w-0 md:h-screen md:overflow-hidden">
        ...
        <main className="flex-1 min-w-0 min-h-0 bg-[var(--bg-app)] flex flex-col overflow-y-auto md:overflow-hidden">
